...
describe('Hacker News Extractor', () => {
  describe('initial test case', () => {
    ...
    it('returns the comments', async () => {
      ...
      assert.equal(
        firstComment.author,
        '<a href="https://news.ycombinator.com/user?id=mouzogu">mouzogu</a>'
      );
