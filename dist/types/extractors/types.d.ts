 ...
 */
export interface SelectionExactlyOne extends BaseSelection<Exclude<Selector, SelectorMatchAll>> {
    type: 'exactlyOne';
    /**
...
export declare type SelectionReturnType<T extends Selection> = SelectionReturnMap[T['type']];
export declare type Selection = SelectionExactlyOne | SelectionConcatinate | SelectionFirstMatch | SelectionMulitpleGrouped | SelectionMultipleArray;
export {};
